    ...
    <footer className="w-full p-6 text-white bg-neutral-800">
      <div className="max-w-6xl mx-auto">
        <p className="mb-4 text-lg leading-relaxed">
          GYM expresa su más sincero agradecimiento a la talentosa
          diseñadora{" "}
          <a
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Cabe aclarar que <span className="font-bold">GYM</span> no es
          un gimnasio real y fue creado únicamente con fines de
          desarrollo y diseño. Además, yo diseñé el logotipo de{" "}
          <span className="font-bold">GYM</span> y utilicé imágenes de
