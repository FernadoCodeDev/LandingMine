...
const ThirdSection = () => {
  return (
    <div className="relative flex flex-col items-center w-full h-auto p-4 text-black bg-beige-300 dark:bg-zinc-900 md:text-2xl dark:text-white">
      <div className="m-auto max-w-[80rem] grid grid-cols-1 gap-4 md:gap-16 md:grid-cols-2">
        ...
        <div className="md:order-4">
          <img src={imgN5} alt="imgN3" className="w-full h-auto" />
        </div>
