...
const FirstSection = () => {
  return (
    <div className="relative flex flex-col items-center justify-center w-full h-auto gap-4 bg-orange-50 dark:bg-sky-900 text-cyan-950 dark:text-orange-50">
      ...
      <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4 m-auto max-w-[80rem]">
        <div className="flex flex-col items-center justify-center order-3 gap-4 md:order-1">
          ...
          <button className="flex justify-center w-full p-2 text-white transition-all duration-700 ease-out rounded-xl md:w-1/3 dark:text-black bg-sky-700 dark:bg-orange-50 md:text-2xl font-antonio hover:bg-sky-950 dark:hover:bg-orange-200">
            Leer Más
          </button>
        </div>
