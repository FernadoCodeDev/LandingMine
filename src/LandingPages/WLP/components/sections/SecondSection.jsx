...
const SecondSection = () => {
  return (
    <div className="relative flex items-center justify-center w-full min-h-screen gap-4 p-4 bg-orange-100 dark:bg-cyan-950 text-cyan-950 dark:text-orange-50">
