...
const ThirdSection = () => {
  return (
    <div className="relative flex flex-col items-center justify-center w-full h-auto gap-4 p-4 bg-orange-50 dark:bg-sky-900 text-amber-50">
      <div className="p-2 grid grid-cols-1 md:grid-cols-2 gap-4 m-auto max-w-[80rem]">
        <div className="">
          <h1 className="pb-2 text-4xl font-bold text-center border-b-2 border-cyan-950 dark:border-orange-50 text-cyan-950 dark:text-orange-50 md:text-6xl">
            HONOR
          </h1>
          ...
          <h1 className="pb-2 text-3xl font-bold text-center border-b-2 border-cyan-950 dark:border-orange-50 text-cyan-950 dark:text-orange-50 md:text-5xl">
            DISCIPLINA
          </h1>
        </div>
        ...
        <div className="flex flex-col justify-start gap-4 ">
          <div className="flex flex-col gap-4">
            ...
            <h1 className="text-3xl font-bold text-center text-cyan-950 dark:text-orange-50">
            ...
            <p className="text-black text-start dark:text-white md:text-xl">
              ...
              <ul>
                <li>
                  {" "}
                  <span className="font-bold text-start text-cyan-950 dark:text-orange-50 md:text-xl">
          ...
          <button className="flex justify-center w-full p-2 font-bold transition-all duration-700 ease-out dark:text-black bg-sky-900 dark:bg-orange-50 md:text-2xl hover:bg-cyan-950 dark:hover:bg-orange-200">
            Subir al Ring
          </button>
        </div>
      </div>
