          ...
          <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
            <div className="grid grid-cols-1 gap-4 p-4 bg-beige-100 dark:bg-neutral-800">
              ...
              <div>
                ...
                <p>
                  Acampa en un entorno natural y seguro con vistas
                  impresionantes. Contamos con espacios diseñados para que
                  disfrutes al máximo de la experiencia, ya sea con tu propia
                  tienda o eligiendo una de nuestras cómodas cabañas rústicas.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 p-4 bg-beige-100 dark:bg-neutral-800">
              ...
              <div>
                ...
                <p>
                  Conéctate con la naturaleza en su máxima expresión. Disfruta
                  de senderos, ríos y paisajes únicos que te permitirán
                  relajarte y vivir momentos inolvidables en un ambiente de paz
                  y armonía.
                </p>
              </div>
            </div>
