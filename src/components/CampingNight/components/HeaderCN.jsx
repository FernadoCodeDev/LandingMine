...
import CampingNightLogo from "../img/CampingNightLogo.webp";
  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      <div className="relative grid items-start h-screen grid-cols-2 gap-2 p-4 md:grid-cols-3">
        <div className="order-3 col-span-2 mx-auto md:col-span-1 md:order-2 md:w-auto md:h-20 ">
          <MobileMenu
        ...
        <img
          ...
          className="order-1 object-contain w-40 h-auto mx-auto cursor-pointer md:order-1"
        />
