...
const HeaderClover = () => {
  return (
    <div className="text-white lg:text-2xl relative grid items-start h-screen grid-cols-2 gap-2  md:grid-cols-3 w-full min-h-screen bg-sky-800">
      ...
      <div className="p-4  w-fit ms-auto order-2 md:order-3">
        <DarkMode />
      </div>
