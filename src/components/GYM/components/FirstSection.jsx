    ...
    <div className="relative grid grid-cols-1 p-4 md:grid-cols-2 bg-neutral-800">
      ...
      <div className="relative p-4 text-white">
        ...
        <p className="text-start text-[1rem] lg:text-[1.4rem] p-1">
          En Gym creemos que, independientemente de la forma y el tamaño, todos
          estamos en un viaje hacia nuestros mejores niveles personales de salud
          y estado físico. Un viaje que nos hace mejores como atletas, amigos y
          personas. Nuestras instalaciones son diferentes a cualquier otro
          gimnasio en el que hayas estado antes.
        </p>
        ...
        <p className="text-start text-[1rem] lg:text-[1.4rem] p-1">
          ...
          entrenamiento a la vez. ¡Ven a una <span className="text-yellow-300">clase de prueba gratuita!</span>  Pierde
          algo de grasa corporal, gana amigos y ponte en forma para toda la
          vida.
        </p>
      </div>
