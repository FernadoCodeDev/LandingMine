      ...
      <main className="flex-grow">
        <section className="items-center py-16 text-center">
          ...
          <p className="mb-8 text-lg dark:text-white">
            ¿Qué es <strong className="text-blue-950 dark:text-orange-300">LandingMine</strong>? Es
            una colección de landing pages inspiradas en diseños como
            <span className="font-bold text-blue-950 dark:text-orange-300"> collectui</span>,
            <span className="font-bold text-blue-950 dark:text-orange-300"> Dribbble</span>,
            <span className="font-bold text-blue-950 dark:text-orange-300"> Behance, </span>
          ...
          <div className="grid grid-cols-1 gap-8 px-4 mx-auto md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-gray-300 rounded-lg shadow-md dark:bg-neutral-700">
              ...
              <div className="p-4">
                <h2 className="text-xl font-semibold dark:text-white">Landing Page 1</h2>
                <p className="text-black dark:text-white">Descripción de la landing page.</p>
            ...
            <div className="bg-gray-200 rounded-lg shadow-md dark:bg-neutral-700">
              <img src={Landing} alt="Landing" className="w-full h-auto" />
              <div className="p-4">
                <h2 className="text-xl font-semibold dark:text-white">Landing Page 2</h2>
                <p className="text-black dark:text-white">Descripción de la landing page.</p>
            ...
            <div className="bg-gray-200 rounded-lg shadow-md dark:bg-neutral-700">
              <img src={Landing} alt="Landing" className="w-full h-auto" />
              <div className="p-4">
                <h2 className="text-xl font-semibold dark:text-white">Landing Page 3</h2>
                <p className="text-black dark:text-white">Descripción de la landing page.</p>
