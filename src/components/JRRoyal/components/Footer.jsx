  ...
  return (
    <footer className="w-full p-6 text-white bg-slate-950">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Cabe aclarar que <span className="font-bold">JR Hotel</span> no
          es un hotel real y fue creado únicamente con fines de desarrollo y
          diseño. Además, yo diseñé el logotipo de{" "}
          <span className="font-bold">JR Hotel</span> y utilicé imágenes de
