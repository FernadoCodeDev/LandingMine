...
const ThirdSection = () => {
  return (
    <div className="relative w-full min-h-screen p-2 text-black bg-gray-900">
      <div className="pt-20 md:pt-32 m-auto flex flex-row justify-between w-full border-b-2 my-2 border-amber-50 p-2 max-w-[100rem]">
        <p className="text-5xl font-fantasy text-amber-50">
          CONSIGUE TUS ENTRADAS
        </p>

        <div className="flex flex-row items-end justify-end gap-2">
          <p className="text-xl text-amber-50">CONSIGUE TUS ENTRADAS</p>
